    ...
    if len(m.command) == 2 and m.command[1].startswith(('notcopy', 'sendall')):
        ...
        if message.command[1].startswith('sendall'):
            verifiedfiles = (
                ...
                f"?start=allfiles_{grp_id}_{file_id}"
            )
        else:
            verifiedfiles = (
                f"https://telegram.me/{temp.U_NAME}"
    ...
    try:
        ...
        if pm_search:
            ...
            if not await db.has_premium_access(user_id):
                ...
                # ==================================================
                # USER HAS NOT JOINED REQUIRED CHANNEL/GROUP
                # ==================================================
                if btn:
                    ...
                    caption = (
                        ...
                        "⚠️ ᴍᴏᴠɪᴇ ᴅᴇᴋʜɴᴇ ᴋᴇ ʟɪʏᴇ "
                        "ᴀᴘᴋᴏ ʀᴇǫᴜɪʀᴇᴅ ᴄʜᴀɴɴᴇʟ ᴀᴜʀ "
                        "ɢʀᴏᴜᴘ ᴊᴏɪɴ ᴋᴀʀɴᴀ ʜᴏɢᴀ.\n\n"
                    ...
                    # isliye movie search yahin stop.
                    return
